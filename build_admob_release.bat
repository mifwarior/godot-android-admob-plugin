...
echo Setting up Gradle and building AdMob plugin (RELEASE)...
...
echo Building AdMob plugin (RELEASE)...
...
echo RELEASE AAR file is in directory: demo\addons\AdmobPlugin\bin\release\
dir demo\addons\AdmobPlugin\bin\release\
